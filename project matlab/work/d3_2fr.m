...
global ZMIN DZX
       %%%вычисление массива данных МА для 1-й градуировочной кривой
       %%%(дистанция I_1_нач_100%...I_1_кон_100%)
cax1=650.;
cax2=950.;
cax21=cax2-cax1;
...
%plot(MA(:,1),MA(:,2))
       ...
       %%%вычисление массива данных МВ для 2-й градуировочной кривой
       %%%(дистанция I_2_нач_100%...I_2_кон_100%)
